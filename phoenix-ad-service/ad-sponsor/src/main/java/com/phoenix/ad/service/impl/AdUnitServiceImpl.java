...
import com.phoenix.ad.constant.Constants;
...
import com.phoenix.ad.service.IAdUnitService;
...
public class AdUnitServiceImpl implements IAdUnitService {
    ...
    public CreativeUnitResponse createCreativeUnit(
        ...
        for (CreativeUnitRequest.CreativeUnitItem creativeUnitItem : request.getUnitItems()) {
            Long unitId = creativeUnitItem.getUnitId();
            unitIds.add(unitId);
        }
